...
function deathCheck() {
    /*
    barv1.value = parseInt(vie_h_1.innerHTML)
    barv2.value = parseInt(vie_h_2.innerHTML)
    barv3.value = parseInt(vie_h_3.innerHTML)
    barv4.value = parseInt(vie_h_4.innerHTML)
    barm1.value = parseInt(mana_h_1.innerHTML)
    barm2.value = parseInt(mana_h_2.innerHTML)
    barm3.value = parseInt(mana_h_3.innerHTML)
    barm4.value = parseInt(mana_h_4.innerHTML)*/
